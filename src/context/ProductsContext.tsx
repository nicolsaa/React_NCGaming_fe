...
export const ProductsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const loadFromStorage = (): Product[] => {
        ...
        const mockProducts: Product[] = [
            { id: '1', name: 'Figura Goku Super Saiyan', price: 20000, description: 'Figura coleccionable de Goku Super Saiyan escala 1/6', image: '/src/assets/images/goku.jpg', category: 'figuras', stock: 15, featured: true },
            { id: '2', name: 'Pokémon Booster Pack', price: 50000, description: 'Sobres de cartas Pokémon edición Scarlet & Violet', image: '/src/assets/images/pokemon-cards.jpg', category: 'cartas', stock: 100, featured: true },
            ...
            { id: "killua-polo", name: "Polera Killua Zoldyck: Lightning Killer - Hunter X Hunter", price: 15990, description: "Polera temática de Killua Zoldyck con diseño Lightning Killer.", image: "/src/assets/images/killua2.png", category: "poleras", stock: 20, featured: true },
            { id: "gojo-polo", name: "Satoru Gojo: Infinite Judgment Edición especial - Jujutsu Kaisen", price: 25000, description: "Polera edición especial Infinite Judgment de Satoru Gojo.", image: "/src/assets/images/gojo.png", category: "poleras", stock: 20, featured: true },
            { id: "shadow-polo", name: "Polera Acid Wash Shadow Monarch - Solo Leveling", price: 8000, description: "Polera estilo Acid Wash inspirada en el Shadow Monarch de Solo Leveling.", image: "/src/assets/images/solo.png", category: "poleras", stock: 20, featured: false },
            { id: "law-hoodie", name: "Polerón Trafalgar Law Tattoos - One Piece", price: 20000, description: "Polerón inspirado en Trafalgar Law con diseño de tatuajes.", image: "/src/assets/images/one.png", category: "polerones", stock: 15, featured: false },
            { id: "homunculos-hoodie", name: "Polerón Homúnculos - Full Metal Alchemist Brotherhood", price: 5000, description: "Polerón inspirado en los Homúnculos de Full Metal Alchemist Brotherhood.", image: "/src/assets/images/fullmetal.png", category: "polerones", stock: 15, featured: true },
